...
public class CaesarServer {
     ...
     * it to the previously specified port. It then waits for clients in a
     * infinite loop. When a client arrives, the server will read its input line
     * by line and send back the data converted to uppercase. This will continue
     * until the client sends the "BYE" command.
     */
    ...
    private class ReceptionistWorker implements Runnable {
         ...
         * This is where we implement the application protocol logic, i.e. where
         * we read data sent by the client and where we generate the responses.
         */
        private class ServantWorker implements Runnable {
            ...
            private final int key = Protocol.generateEncryptingKey();
    ...
    public static void main(String[] args) {
        ...
        CaesarServer c = new CaesarServer(Protocol.A_CONSTANT_SHARED_BY_CLIENT_AND_SERVER);
        c.serveClients();
    }
